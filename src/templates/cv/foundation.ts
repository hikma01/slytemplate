import type {CoreDesignInputs} from '../../core/index.js';
import type {TemplateContract} from '../../contracts/index.js';

export const cvFoundationTemplate: TemplateContract = {
...
export const cvFoundationDesignInputs: CoreDesignInputs = {
