...
const tree = { document: { document_id: 'chromium-doc' }, pages: [], nodes: [{ slot_reference: 'identity', visual_role: 'identity', content: 'Zoë Łucas — 李明' }], applied_template: version, applied_tokens: version, diagnostics: [] };
const request = { tree, request_id: 'chromium-request', traceId: 'trace-chromium', contextId: 'context-chromium', lineage: [], presentationContractVersion: '1.0.0', templateId: 'cv-foundation-01', templateVersion: '1.0.0', designPolicyVersion: version, tokenSetVersion: version, timeoutMs: 15000 };
...
//# sourceMappingURL=chromium.test.js.map